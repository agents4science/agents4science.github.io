...
AotW#1 is [OPAL - Plant Phenotyping Analysis Agent](https://github.com/AI-ModCon/BaseCAF_agent_of_the_week/blob/main/AotW-1-OPAL.md)

AotW#2 is [IGNOS — Fusion Foundation Model](https://github.com/AI-ModCon/BaseCAF_agent_of_the_week/blob/main/AotW-02-Ignos.md)
