#!/usr/bin/env python3
"""
Create illustrative overview figures for the two Applications.
"""

import matplotlib.pyplot as plt
import matplotlib.patches as mpatches
from matplotlib.patches import FancyBboxPatch, Circle, FancyArrowPatch, Arrow, Polygon
import numpy as np
...
def create_polynomial_discovery_figure():
    ...
    plt.tight_layout()
    plt.savefig('PolynomialDiscovery/figures/overview.png', dpi=150, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    print("Saved: PolynomialDiscovery/figures/overview.png")
    plt.close()
...
def create_rule_discovery_figure():
    ...
    plt.tight_layout()
    plt.savefig('RuleDiscovery/figures/overview.png', dpi=150, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    print("Saved: RuleDiscovery/figures/overview.png")
    plt.close()
...
def main():
    ...
    import os
    os.makedirs('PolynomialDiscovery/figures', exist_ok=True)
    os.makedirs('RuleDiscovery/figures', exist_ok=True)

    create_polynomial_discovery_figure()
    create_rule_discovery_figure()
    print("\nOverview figures created successfully!")
