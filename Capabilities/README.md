...
<div style="flex: 1; min-width: 300px; border: 1px solid #ddd; border-radius: 8px; padding: 1rem;">
<h3>4. <a href="governed-tool-use.md">Governed Tool Use at Scale</a></h3>
...
<div style="flex: 1; min-width: 300px; border: 1px solid #ddd; border-radius: 8px; padding: 1rem;">
<h3>5. <a href="multi-agent-coordination.md">Multi-Agent Coordination</a></h3>
...
<div style="flex: 1; min-width: 300px; border: 1px solid #ddd; border-radius: 8px; padding: 1rem;">
<h3>6. <a href="long-lived-agents.md">Long-Lived Autonomous Agents</a></h3>
...
<h3>7. <a href="agent-workflows.md">Agent-Mediated Scientific Workflows</a></h3>
...
|:-----:|------------|-----------------|----------------|---------------|-------|:------:|
| 1 | [Local Agent Execution](local-agents.md) | Run persistent, stateful agents | LangGraph | Laptop, workstation, VM | Single agent | Mature |
| 2 | [Federated Agent Execution](federated-agents.md) | Invoke tools under federated identity | LangGraph + Academy | DOE HPC | Multi-resource | Mature |
| 3 | [Parallel Agent Inference](scale-inference.md) | Fan out thousands of LLM requests | LangGraph + FIRST | HPC accelerators | O(10³–10⁴) streams | Prototype |
| 4 | [Governed Tool Use](governed-tool-use.md) | Invoke tools under policy enforcement | Academy governance | DOE HPC | O(10²–10³) tools | WIP |
| 5 | [Multi-Agent Coordination](multi-agent-coordination.md) | Coordinate agents under shared governance | Shared state + policy | Distributed | O(10²–10³) agents | Emerging |
| 6 | [Long-Lived Agents](long-lived-agents.md) | Persistent agents with memory and goals | Lifecycle management | Any | Days–months | Emerging |
| 7 | [Agent Workflows](agent-workflows.md) | Dynamic workflow construction | Workflow integration | DOE infrastructure | Varies | Early |
